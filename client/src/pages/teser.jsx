    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 m-3 space-y-4">
          ...
          >
            <FaMapMarkerAlt  className={`${isHovered ? "text-xl" : "text-2xl"}`} />
          ...
          >
            <FaDollarSign  className={`${isHovered ? "text-xl" : "text-2xl"}`} />
          ...
          >
            <FaRegCalendarAlt  className={`${isHovered ? "text-xl" : "text-2xl"}`} />
          ...
          >
            <FaBell  className={`${isHovered ? "text-xl" : "text-2xl"}`} />
          ...
          >
            <FaEnvelope  className={`${isHovered ? "text-xl" : "text-2xl"}`} />
          ...
          >
            <FaPlus  className={`${isHovered ? "text-xl" : "text-2xl"}`} />
          ...
          >
            <FaUser className={`${isHovered ? "text-xl" : "text-2xl"}`} />
