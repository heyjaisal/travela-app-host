...
import { FaMap,FaTrash ,FaEdit, FaUpload } from "react-icons/fa";
  ...
  const onDrop = async (acceptedFiles) => {
    ...
    reader.onloadend = async () => {
      try {
        ...
        setEventForm((prev) => ({
          ...prev,
          image: response.data.imageUrl, // save the image URL from the response
        }));
  ...
  const { getRootProps, getInputProps } = useDropzone({
    ...
    onDrop: (acceptedFiles, fileRejections) => {
      if (fileRejections.length > 0) {
        ...
        onDrop(acceptedFiles);  // Call the onDrop function here
      }
    },
  });
  ...
  return (
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold text-gray-700">Event Venue</label>
          <input
            type="text"
            name="eventVenue"
        ...
        <div className="mb-4">
          ...
          <div className="flex">
            <input
              ...
              placeholder={eventForm.isFreeTicket ? "Free Ticket" : "Enter the ticket price"}
              className="mt-2 block w-full p-3 rounded-lg border border-gray-300 shadow-sm focus:ring-2 focus:ring-purple-600 focus:outline-none"
            />
            <button
              type="button"
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold text-gray-700">Event Date and Time</label>
          <DateTimePicker
            sx={{ width: "100%" }}
      ...
      {/* Add features */}
      <div className="mb-4">
        <label className="block text-sm font-poppins font-bold text-gray-700">Add new features</label>
        <div className="flex">
          <input
            type="text"
            value={featurestext}
    ...
    {/* Right Section: Image Upload and Map */}
    <div>
